  ...
  return (
    <ReactMarkdown
      ...
      components={{
        p: ({ node, ...props }) => (
          <p
            className={`my-2 leading-relaxed text-sm md:text-base ${
              isLarge ? 'md:text-lg' : ''
            }`}
            {...props}
          />
        ...
        h1: ({ node, ...props }) => (
          <h1
            className="my-3 font-bold text-xl md:text-2xl lg:text-3xl"
            {...props}
          />
        ),
        h2: ({ node, ...props }) => (
          <h2
            className="my-2 font-semibold text-lg md:text-xl lg:text-2xl"
            {...props}
          />
        ),
        h3: ({ node, ...props }) => (
          <h3 className="my-1 font-medium text-md md:text-lg" {...props} />
        ),
        ul: ({ node, ...props }) => (
        ...
        ol: ({ node, ...props }) => (
          <ol
            className="pl-5 my-2 list-decimal text-sm md:text-base"
            {...props}
          />
        ),
        ...
        thead: ({ node, ...props }) => (
          <thead
            className="bg-gray-200 text-xs md:text-sm font-semibold"
            {...props}
          />
        ),
        ...
        td: ({ node, ...props }) => (
          <td className="px-4 py-2 text-sm md:text-base" {...props} />
        ),
        img: ({ src, alt, ...props }) => (
